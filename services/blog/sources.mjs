...
export const defaultSources = Object.freeze([
  ...
  source({ id: "nodejs", name: "Node.js Blog", feedUrl: "https://nodejs.org/en/feed/blog.xml", homepageUrl: "https://nodejs.org/en/blog", allowedHosts: ["nodejs.org"], language: "en", trustTier: "primary", sourceKind: "official", topics: ["software", "web"] }),
