...
export const defaultSources = Object.freeze([
  ...
  source({ id: "applenews", name: "Apple Newsroom", feedUrl: "https://www.apple.com/newsroom/rss-feed.rss", homepageUrl: "https://www.apple.com/newsroom/", allowedHosts: ["www.apple.com", "apple.com"], language: "en", trustTier: "primary", sourceKind: "official", topics: ["hardware", "software", "ai"] }),
  source({ id: "appledev", name: "Apple Developer News", feedUrl: "https://developer.apple.com/news/rss/news.rss", homepageUrl: "https://developer.apple.com/news/", allowedHosts: ["developer.apple.com"], language: "en", trustTier: "primary", sourceKind: "official", topics: ["software", "ai", "hardware"] }),
  source({ id: "googleai", name: "Google AI Blog", feedUrl: "https://blog.google/technology/ai/rss/", homepageUrl: "https://blog.google/technology/ai/", allowedHosts: ["blog.google"], language: "en", trustTier: "primary", sourceKind: "official", topics: ["ai"] }),
  source({ id: "msresearch", name: "Microsoft Research", feedUrl: "https://www.microsoft.com/en-us/research/blog/feed/", homepageUrl: "https://www.microsoft.com/en-us/research/blog/", allowedHosts: ["www.microsoft.com", "microsoft.com"], language: "en", trustTier: "primary", sourceKind: "official", topics: ["ai", "science", "software"] }),
