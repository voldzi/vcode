...
10. Run one draft-only generation. Review both languages, citations, disclosure, usage and budget records before publishing it.
11. Enable scheduled generation only after the controlled run succeeds.
